...
/** A road */
USTRUCT( BlueprintType )
struct STREETMAPRUNTIME_API FStreetMapRoad : public FTableRowBase
{
	GENERATED_USTRUCT_BODY()
...
/** A building */
USTRUCT( BlueprintType )
struct STREETMAPRUNTIME_API FStreetMapBuilding : public FTableRowBase
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	/** List of roads */
	UPROPERTY( Category=StreetMap, VisibleAnywhere, BlueprintReadWrite)
